...
export const transformHelp: Record<TransformType, TransformHelp> = {
  scale: {
    title: "Scale",
    ...
    params: [
      {
        name: "factor",
        description: "倍率。大于 1 会整体放大，小于 1 会整体缩小。",
      },
    ],
  ...
  trend: {
    ...
    params: [
      {
        name: "strength",
        description: "趋势强度。数值越大，曲线尾部偏移越明显。",
      },
      {
        name: "direction",
        description: "趋势方向。up 表示逐渐上升，down 表示逐渐下降。",
      },
    ],
  ...
  noise: {
    ...
    params: [
      {
        name: "sigma",
        description: "噪声标准差。越大，波动越明显。",
      },
      {
        name: "seed",
        description: "随机种子。同一个 seed 会生成相同的噪声结果。",
      },
    ],
  },
  smooth: {
    ...
    params: [
      {
        name: "windowSize",
        description: "移动平均窗口大小。越大越平滑，但细节损失越多。",
      },
    ],
    ...
    params: [
      {
        ...
        description: "参考曲线。当前 active 曲线会按 blend 向它靠近。",
      },
      {
        name: "blend",
        description: "混合比例。0 只保留当前曲线，1 完全使用参考曲线。",
      },
      {
        name: "amplitudeFactor",
        description: "围绕均值调整振幅。大于 1 放大起伏，小于 1 压缩起伏。",
      },
      {
        name: "trendStrength",
        description: "额外线性趋势强度。正数让尾部更高，负数让尾部更低。",
      },
    ],
